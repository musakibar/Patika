...
namespace telefonrehberi
{
    public class Rehber
    {
        ...
        public Rehber()
        {
            kisiBilgiKarti.Add(new KisiBilgiKarti("Musa","Kibar","123456789"));
            kisiBilgiKarti.Add(new KisiBilgiKarti("Ali","Nurkoyuncu","23456789"));
            kisiBilgiKarti.Add(new KisiBilgiKarti("Mehmet","Mutlu","3456789"));
            kisiBilgiKarti.Add(new KisiBilgiKarti("Alperen","Şener","456789"));
            kisiBilgiKarti.Add(new KisiBilgiKarti("Ahmet","Kibar","56789"));
        }
